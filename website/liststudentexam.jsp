...
select c.roll_no from slave as a,slave as b,student as c,student as d where a.timeslot_id=b.timeslot_id and a.course_id<b.course_id and a.course_id=c.course_id and b.course_id=d.course_id and c.roll_no=d.roll_no and a.course_id="<%= course1 %>" and b.course_id="<%= course2 %>"
