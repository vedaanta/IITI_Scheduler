...
select a.course_id,b.course_id,b.classroom from slave as b,slave as a where b.timeslot_id=a.timeslot_id and b.classroom=a.classroom and a.course_id<b.course_id
</sql:query>
